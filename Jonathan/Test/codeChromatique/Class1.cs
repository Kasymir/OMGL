...
namespace System.Windows.Ink
{
    ...
    public class DrawingAttributes : INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <param name="e">The change information for the DrawingAttribute that was modified
        ...
        /// </summary>
        /// <param name="e">The change information for the PropertyData that was modified
        ...
        /// </summary>
        /// <param name="e">The EventArgs specifying the name of the changed property.
        ...
        /// </summary>
        /// <param name="sender">Should be 'this' object
        /// <param name="args">The custom attributes that changed
